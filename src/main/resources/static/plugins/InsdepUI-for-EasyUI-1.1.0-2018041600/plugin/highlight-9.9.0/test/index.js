...
// Tests meant for the browser only. Using the `test/fixtures/index-easyui.html` file
...
// and several other cases. Do note that the `test/fixtures/index-easyui.html` file
